...
- Existing footage may suggest a strategy to reduce dependence on new filming only if reuse rights are separately verified; do not assume it can be commercially reused.
...
CERTAINTY / SEVERITY
Historical schedule changes support risk of future change, not certainty. Avoid severe, impossible, mandatory, prohibited, catastrophic, or equivalent intensity/certainty terms unless directly evidenced.
